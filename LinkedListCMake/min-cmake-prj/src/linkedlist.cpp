...
*/
bool labtpa::is_empty(LinkedList* ll){
    // write here
...
*/                
void labtpa::add(LinkedList* ll, const char * label){    
 ...
 *      s += "some characters"
*/
string labtpa::to_string(LinkedList* ll) {
            
    // write here

    labtpa::Node* current = ll->head;
    string display;
...
*/
bool search(labtpa::LinkedList* ll, const char * label){
                
    // write here
    labtpa::Node* temp = ll->head;
